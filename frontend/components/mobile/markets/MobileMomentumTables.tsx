...
interface MobileMomentumTablesProps {
  trends: TrendSnapshot[];
}

export default function MobileMomentumTables({ trends }: MobileMomentumTablesProps) {
  const gridTrends = trends.slice(0, 12);

  return (
    <section id="momentum" className="mobile-section">
      <div className="mobile-section__header">
        <div>
          <h2 className="mobile-section__title">Momentum Tables</h2>
          <p className="mobile-section__subtitle">Fast-moving topics sorted by strength</p>
        </div>
